...
class kisahController extends Controller
{
    ...
    {
        $kisah = DB::select('select kisah.id as kisah_id, users.id as user_id, users.name, users.icon, judul, sinopsis, isi, genre  from kisah join users on kisah.user_id=users.id join genre on genre.kisah_id=kisah.id');
